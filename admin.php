...
if(isset($_POST['product_entry'])){
  ...
  $query1 = "INSERT INTO product_list (product_id,product_name,price, image_name , catagory)
        VALUES('$id','$name','$price','$image','$image_text')";
...
<head>
    ...
    <!-- required -->
	<link rel="stylesheet" type="text/css" media="all" href="admin/css/stellarnav.css">
	<!-- required -->
    ...
    <!-- favicons
    ================================================== -->
    <link rel="shortcut icon" href="favicon.png" type="admin/image/x-icon">
...
<body id="top">
    ...
    <header class="s-header">
      ...
      <ul>
        ...
        <li><a class="smoothscroll"  href="#contact" title="Quick Order">Quick Order</a></li>
        <li><a class="#"  href="admin_post.php" title="Product Upload">Product Upload</a></li>
      </ul>
    </div><!-- .stellarnav -->
  </header>
    ...
    <!-- home
    ================================================== -->
    <section id="home" class="s-home page-hero target-section" data-parallax="scroll" data-image-src="admin/images/hero-bg.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
            ...
            <div class="col-full">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                  <table border="0">
                    ...
                    <tr>
                        <input id="text" type="text" name="image_text" placeholder="Image catagory"></textarea>
                    </tr>
                    <tr>
                      <td>Price :</td>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!-- required -->
    	...
    	<script type="text/javascript" src="admin/js/stellarnav.min.js"></script>
